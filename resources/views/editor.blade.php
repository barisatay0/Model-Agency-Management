...
<body>
    ...
    <div class="mt-2 text-center mb-2">
        <a class="text-black " style="text-decoration: none" href="{{ url('/List') }}"><button
                class="btn btn-outline-black w-25 py-1">Models</button></a>
        <a class="text-black " style="text-decoration: none" href="{{ url('/') }}"><button
                class="btn btn-outline-black w-25 py-1">Data</button></a>
    </div>
    @if ($errors->any())
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-xl-9">
                        <div class="table-responsive">
                            ...
                            <div>
                                <button type="submit" class="btn btn-outline-black w-100 btn-md">Add
                                    Model</button>
                            </div>
                        </div>
                    </div>
